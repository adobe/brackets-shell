...
2. Open brackets-shell\appshell\mac\Info.plist and change `CFBundleVersion`
3. Open brackets\src\package.json and change `"version"`
...
5. Run installer/win/setBuildNumber.sh (in the Git Bash window)
